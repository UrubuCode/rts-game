// ═══════════════════════════════════════════════════════════════════════════
// CASTELO SOB FOGO E ÁGUA — a fusão dos dois mundos de física do motor.
//
//   rts.exe run castelo_agua_demo.ts
//
...
let CD_W = 1500;
let CD_H = 950;
const app = createAppAt("RTS — Castelo Sob Fogo e Agua", CD_W, CD_H, 60, 40);
const WIN = app._win;
