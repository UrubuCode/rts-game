...
import { Collider as Component1 } from "../core/collider";
import { PhysicsMaterial as Component2 } from "../../scripts/physicsmaterial";
import { Rigidbody as Component3 } from "../../scripts/rigidbody";
import { Camera as Component4 } from "../core/camera";
import { Material as Component5 } from "../core/material";
import { MeshRenderer as Component6 } from "../core/meshrenderer";
import { Bobber as Component7 } from "../../scripts/bobber";
import { MotionSettings as Component8 } from "../../../assets/scripts/MotionSettings";
import { Mover as Component9 } from "../../scripts/mover";
import { Orbit as Component10 } from "../../scripts/orbit";
...
export function createRegisteredComponent(name: string): Behavior {
  ...
  if (name === "Collider") return new Component1();
  if (name === "PhysicsMaterial") return new Component2();
  if (name === "Rigidbody") return new Component3();
  if (name === "Camera") return new Component4();
  if (name === "Material") return new Component5();
  if (name === "MeshRenderer") return new Component6();
  if (name === "Bobber") return new Component7();
  if (name === "MotionSettings") return new Component8();
  if (name === "Mover") return new Component9();
  if (name === "Orbit") return new Component10();
