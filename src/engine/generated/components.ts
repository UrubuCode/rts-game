...
import { Animator as Component1 } from "../../scripts/animator";
import { VitrineContador as Component2 } from "../../../assets/scripts/VitrineContador";
import { VitrineHud as Component3 } from "../../../assets/scripts/VitrineHud";
import { Collider as Component4 } from "../core/collider";
import { PhysicsMaterial as Component5 } from "../../scripts/physicsmaterial";
import { Rigidbody as Component6 } from "../../scripts/rigidbody";
import { Camera as Component7 } from "../core/camera";
import { Material as Component8 } from "../core/material";
import { MeshRenderer as Component9 } from "../core/meshrenderer";
import { Skeleton as Component10 } from "../core/skeleton";
import { Bobber as Component11 } from "../../scripts/bobber";
import { MotionSettings as Component12 } from "../../../assets/scripts/MotionSettings";
import { Mover as Component13 } from "../../scripts/mover";
import { Orbit as Component14 } from "../../scripts/orbit";
import { Patrol as Component15 } from "../../scripts/patrol";
import { Pulse as Component16 } from "../../scripts/pulse";
import { Spinner as Component17 } from "../../scripts/spinner";
import { UIButton as Component18 } from "../core/ui_button";
import { UIText as Component19 } from "../core/ui_text";
import { AudioSource as Component20 } from "../../scripts/audiosource";
...
export function createRegisteredComponent(name: string): Behavior {
  ...
  if (name === "Animator") return Component1.createDefault();
  if (name === "VitrineContador") return new Component2();
  if (name === "VitrineHud") return new Component3();
  if (name === "Collider") return new Component4();
  if (name === "PhysicsMaterial") return new Component5();
  if (name === "Rigidbody") return new Component6();
  if (name === "Camera") return new Component7();
  if (name === "Material") return new Component8();
  if (name === "MeshRenderer") return new Component9();
  if (name === "Skeleton") return new Component10();
  if (name === "Bobber") return new Component11();
  if (name === "MotionSettings") return new Component12();
  if (name === "Mover") return new Component13();
  if (name === "Orbit") return new Component14();
  if (name === "Patrol") return new Component15();
  if (name === "Pulse") return new Component16();
  if (name === "Spinner") return new Component17();
  if (name === "UIButton") return new Component18();
  if (name === "UIText") return new Component19();
  if (name === "AudioSource") return new Component20();
...
export function restoreRegisteredComponent(data: any): any {
  ...
  if (data.type === "script:assets/scripts/MotionSettings.ts#MotionSettings") {
    const component = new Component12();
    if (data.fields === undefined || data.fields === null) return component;
